            ...
            if (w()) {
                ...
                [].forEach.call(a, function(a) {
                    if (a.querySelector("[video-to-image-on-mobile]")) {
                        var b =
                            a.querySelector("[video-to-image-on-mobile]").getAttribute("video-to-image-on-mobile");
                ...
                var b = function(a) {
                        ...
                        if (1 < b.getAttribute("data-visible")) {
                            ...
                            if (a.parents().some(function(a) {
                                    ...
                                    return a.getAttribute("data-cloned-index") >=
                                        c
                                })) return !0;
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.com/web-page-maker.html">Web Page Builder</a> Mobirise v5.6.5 <a href="https://mobirise.com/bio/link-in-bio.html">Link Bio</a>';
